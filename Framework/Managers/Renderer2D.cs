...
namespace ScrapBox.Framework.Managers
{
    public static class Renderer2D
    {
        ...
        {
            RenderSprite(texture, position, dimensions, rotation, null, camera, depth);
        }
        ...
        public static void RenderSprite(Texture2D texture, ScrapVector position, ScrapVector dimensions, float rotation, Rectangle? sourceRectangle, Camera camera,
                float depth = 0)
        {
            RenderSprite(texture, position, dimensions, rotation, sourceRectangle, Color.White, camera, depth);
        }
        ...
        {
            RenderSprite(texture, position, dimensions, rotation, sourceRectangle, tintColor, SpriteEffects.None, camera, depth);
        }
