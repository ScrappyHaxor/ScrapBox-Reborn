    ...
    public class DataLoader
    {
        ...
        public void ReadData(string data)
        {
            ...
            for (int i = 0; i < data.Length; i++)
            {
                ...
                if (curChar == ':')
                {
                    int startIndex = GetNthIndex(data.Substring(skipIndex, (int)ScrapMath.Abs(i-skipIndex)), '"', 1);
                    ...
                    string line = data.Substring(startIndex, (int)ScrapMath.Abs(endIndex-skipIndex)-2);
                    ...
                    values.Add(line.Substring(0, separator), line[(separator + 1)..]);
